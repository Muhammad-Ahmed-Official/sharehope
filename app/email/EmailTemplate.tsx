...
<style>
  ...
  .header {
    font-size: 28px;
    font-weight: bold;
    background: linear-gradient(135deg, hsl(25,95%,60%) 0%, hsl(25,85%,50%) 100%);
...
<body>
  <div class="container">
    ...
    <p>Dear <span>${donorName}</span>,</p>
    <p>Thank you for your generous donation to <span>${ngoName}</span>.</p>
    <div class="donation-details">
      Amount Donated: <strong>Rs. ${amount}</strong>
    </div>
